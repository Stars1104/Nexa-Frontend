      ...
      <circle cx="8" cy="8" r="8" class="iti__search-clear-bg" mask="url(#${maskId})" />
        ...
        var UI = class {
          ...
          _prepareTelInput() {
            ...
            if (!this.telInput.hasAttribute("autocomplete") && !((_a = this.telInput.form) == null ? void 0 : _a.hasAttribute("autocomplete"))) {
          ...
          _maybeBuildHiddenInputs(wrapper) {
            ...
            if (hiddenInput) {
              ...
              if (names.phone) {
                const existingInput = (_a = this.telInput.form) == null ? void 0 : _a.querySelector(
              ...
              if (names.country) {
                const existingInput = (_b = this.telInput.form) == null ? void 0 : _b.querySelector(
        ...
        var Iti = class _Iti {
          ...
          _initHiddenInputListener() {
            ...
            (_a = this.ui.telInput.form) == null ? void 0 : _a.addEventListener("submit", handleHiddenInputSubmit, {
          ...
          _initRequests() {
            ...
            if (loadUtils && !intlTelInput.utils) {
              const doAttachUtils = () => {
                var _a;
                (_a = intlTelInput.attachUtils(loadUtils)) == null ? void 0 : _a.catch(() => {
                });
              };
          ...
          _bindInputListener() {
            ...
            const handleInputEvent = (e) => {
              ...
              const isFormattingChar = (e == null ? void 0 : e.data) && REGEX.NON_PLUS_NUMERIC.test(e.data);
              const isPaste = (e == null ? void 0 : e.inputType) === INPUT_TYPES.PASTE && this.ui.telInput.value;
              if (isFormattingChar || isPaste && !strictMode) {
                userOverrideFormatting = true;
              } else if (!REGEX.NON_PLUS_NUMERIC.test(this.ui.telInput.value)) {
                userOverrideFormatting = false;
              }
              const isSetNumber = (e == null ? void 0 : e.detail) && e.detail["isSetNumber"];
              if (formatAsYouType && !userOverrideFormatting && !isSetNumber) {
                ...
                const isDeleteForwards = (e == null ? void 0 : e.inputType) === INPUT_TYPES.DELETE_FWD;
          ...
          _bindDropdownMouseoverListener(signal) {
            const handleMouseoverCountryList = (e) => {
              var _a;
              const listItem = (_a = e.target) == null ? void 0 : _a.closest(
          ...
          _handleUpDownKey(key) {
            var _a, _b;
            let next = key === KEYS.ARROW_UP ? (_a = this.ui.highlightedItem) == null ? void 0 : _a.previousElementSibling : (_b = this.ui.highlightedItem) == null ? void 0 : _b.nextElementSibling;
...
export default require_intlTelInput();
