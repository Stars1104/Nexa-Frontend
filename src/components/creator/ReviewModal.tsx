  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (error.response?.status === 400) {
        ...
        errorMessage = "Apenas criadores podem criar avaliações";
        ...
        <DialogHeader>
          ...
          <DialogDescription>
            ...
            <span className="font-semibold">
              {contract.brand?.name || contract.other_user?.name || "Marca"}
            </span>{" "}
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <Textarea
              ...
              placeholder="Compartilhe sua experiência com esta marca..."
              rows={4}
              maxLength={1000}
            />
          ...
          <div className="flex items-center space-x-2">
            ...
            <Label htmlFor="public-review" className="text-sm">
              Tornar esta avaliação pública no perfil da marca
            </Label>
          </div>
        </div>
